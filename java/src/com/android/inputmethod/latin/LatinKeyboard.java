    ...
    protected Key createKeyFromXml(Resources res, Row parent, int x, int y, 
        ...
        switch (key.codes[0]) {
            ...
            case LatinIME.KEYCODE_SPACE:
                ...
                break;
            case -5:
                key.icon = mRes.getDrawable(R.drawable.sym_keyboard_delete);
                break;
            case 9:
                key.icon = mRes.getDrawable(R.drawable.sym_keyboard_tab);
                break;
            case -1:
                key.icon = mRes.getDrawable(R.drawable.sym_keyboard_shift);
                break;
            case -100:
                key.icon = mRes.getDrawable(R.drawable.sym_keyboard_settings);
                break;
            case -102:
                key.icon = mRes.getDrawable(R.drawable.sym_keyboard_mic);
                break;
