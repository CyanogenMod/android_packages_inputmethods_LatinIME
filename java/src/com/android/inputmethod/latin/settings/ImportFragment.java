...
public class ImportFragment extends SubScreenFragment implements AdapterView.OnItemClickListener {
     ...
     * @param context
     */
    public ArrayList<ImportDictionary> showFilesFromPackage(final Context context, ApplicationInfo info) {
                ...
                for (String filePath : list){
                    ...
                    if (filePath.endsWith(".dict")) {
                        ...
                        DictionaryHeader header =
                                DictionaryInfoUtils.getDictionaryFileHeaderOrNull(file);
                        if (header != null) {
                            files.add(new ImportDictionary(file, header));
                        }
                    }
                }
            } catch (IOException e) {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
        ...
        if (info != null) {
            ArrayList<ImportDictionary> files = showFilesFromPackage(getActivity(), info);
    ...
    public class ImportDictionary {
        ...
        public ImportDictionary(File file, DictionaryHeader header) {
            this.file = file;
            this.header = header;
